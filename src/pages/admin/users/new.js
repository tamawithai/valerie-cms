...
export default function NewUser() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Kirim data ke API untuk membuat pengguna baru
                      ...
                      <div className="flex">
                        <div className="flex-shrink-0">
                          <svg className="h-5 w-5 text-blue-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                            <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 102 0v-3a1 1 0 10-2 0zm0 8a1 1 0 110-2 1 1 0 010 2z" clipRule="evenodd" />
                          </svg>
                        </div>
                        <div className="ml-3">
